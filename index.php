...
?>
			<form action="append.php" id="mainform" method="POST" name="mainform">
				...
				<div class="debug">
					...
					<p>This is a list of transactions awaiting submission. Until you click submit, these transactions are temporary and will vanish if the browser is closed or crashes.
					<br />
					<i>Remember to submit regularly while we are offline.</i></p>
